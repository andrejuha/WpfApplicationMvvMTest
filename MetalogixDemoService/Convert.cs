...
namespace MetalogixDemoService
{
    public static class Convert
    {
        ...
        public static IEnumerable<CompanyTypeItem> ConvertCompanyWcfTypeItemsToData(this CompanyWcfTypeItem[] ci)
        {
            List<CompanyTypeItem> CompanyItemList = new List<CompanyTypeItem>();
            foreach (var ciItem in ci)
            {
                CompanyItemList.Add(ciItem.ConvertCompanyItemToData());
            }
        ...
        public static IEnumerable<CompanyTypeItem> ConvertCompanyWcfTypeItemsToData(this IEnumerable<CompanyWcfTypeItem> ci)
        {
            List<CompanyTypeItem> CompanyItemList = new List<CompanyTypeItem>();
            foreach (var ciItem in ci)
            {
        ...
        public static IEnumerable<CompanyWcfTypeItem> ConvertCompanyTypeItemsToWcf(this CompanyTypeItem[] ci)
        {
            List<CompanyWcfTypeItem> CompanyItemList = new List<CompanyWcfTypeItem>();
            foreach (var ciItem in ci)
            {
        ...
        public static IEnumerable<CompanyWcfTypeItem> ConvertCompanyTypeItemsToWcf(this IEnumerable<CompanyTypeItem> ci)
        {
            List<CompanyWcfTypeItem> CompanyItemList = new List<CompanyWcfTypeItem>();
            foreach (var ciItem in ci)
            {
